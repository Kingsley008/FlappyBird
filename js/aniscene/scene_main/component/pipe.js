class Pipe {
    ...
    setup() {
        for (var i = 0; i < this.columsOfPipe; i++) {
            var pipeT = new AniImage('pipeT', this.game, 0, 0);
            var pipeB = new AniImage('pipeB', this.game, 0 ,0);
    ...
    debug() {
        this.spaceBetweenTopBottom = conf_player.spaceBetweenTopBottom.value;
        this.spaceBetweenPipe = 300;
        this.speed = conf_player.pipesMoveSpeed.value;
